...
function init() {
    ...
    // let gridYZ1 = new THREE.GridHelper(BOARD_SIZE / 2, BOARD_SIZE / 2 / VOXEL_SIZE, 0xdddddd, 0xdddddd);
    // gridYZ1.position.set(-200, 0, 100);
    // gridYZ1.rotation.z = Math.PI / 2;
    // scene.add(gridYZ1);
    // exclusion.push(gridYZ1);
    // let gridYZ2 = new THREE.GridHelper(BOARD_SIZE / 2, BOARD_SIZE / 2 / VOXEL_SIZE, 0xdddddd, 0xdddddd);
    // gridYZ2.position.set(-200, 0, -100);
    // gridYZ2.rotation.z = Math.PI / 2;
    // scene.add(gridYZ2);
    // exclusion.push(gridYZ2);
    // let gridXZ1 = new THREE.GridHelper(BOARD_SIZE / 2, BOARD_SIZE / 2 / VOXEL_SIZE, 0xdddddd, 0xdddddd);
    // gridXZ1.position.set(100, 0, -200);
    // gridXZ1.rotation.x = Math.PI / 2;
    // scene.add(gridXZ1);
    // exclusion.push(gridXZ1);
    // let gridXZ2 = new THREE.GridHelper(BOARD_SIZE / 2, BOARD_SIZE / 2 / VOXEL_SIZE, 0xdddddd, 0xdddddd);
